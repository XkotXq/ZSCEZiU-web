...
export default function page({ params }) {
    ...
    const getPosts = async () => {
        try {
            const res = await fetch(`${apiUrl}/api/services/accepted/tz`)
            if (!res.ok) {
            ...
            <div className="flex flex-col">
                <div className="bg-cover relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-40 p-3 rounded-xl">
                        <h1 className="text-3xl font-bold tracking-tight">Blog dla zawodu technik żywienia i usług gastronomicznych / kucharz</h1>
