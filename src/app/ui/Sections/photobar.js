...
export default function PhotoBar({ path }) {
    return (
        <div className="w-full h-64 relative rounded-md overflow-hidden mt-2 text-center">
            <Image src="/default-banner.jpg" height={256} width={1500} loading="lazy" alt="baner" className="object-cover brightness-50"/>
